...
const storyboard_controller_1 = require("./storyboard.controller");
...
exports.StoryboardModule = StoryboardModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [storyboard_controller_1.StoryboardController],
        providers: [storyboard_service_1.StoryboardService, database_1.DatabaseService, ai_service_1.AiService],
    })
], StoryboardModule);
